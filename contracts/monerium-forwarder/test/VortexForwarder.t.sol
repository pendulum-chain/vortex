...
contract MockReentrantRouter {
    function exactInput(ISwapRouter02.ExactInputParams calldata) external payable returns (uint256) {
        VortexForwarder(msg.sender).swapAndForward(0); // must revert via reentrancy guard
        return 0;
    }
}
