...
export const RampToggle = ({ activeDirection, onToggle }: RampToggleProps) => {
  ...
  return (
    <div className="relative mb-6 flex justify-center">
      <button
        className={cn(
          "relative z-10 flex-1 cursor-pointer px-4 py-2 text-center font-bold text-2xl transition-colors duration-150",
          activeDirection === RampDirection.BUY ? "text-primary" : "text-gray-500 hover:text-gray-700"
        )}
      ...
      <button
        className={cn(
          "relative z-10 flex-1 cursor-pointer px-4 py-2 text-center font-bold text-2xl transition-colors duration-150",
          activeDirection === RampDirection.SELL ? "text-primary" : "text-gray-500 hover:text-gray-700"
        )}
