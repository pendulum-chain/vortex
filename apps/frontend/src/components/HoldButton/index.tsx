...
export function HoldButton({
  ...
  return (
    <button
      className={cn(
        "relative flex h-12 w-full cursor-pointer select-none items-center justify-center gap-2 overflow-hidden rounded-lg bg-gray-100 font-medium text-gray-500 transition-transform duration-150 ease-out active:scale-[0.98]",
