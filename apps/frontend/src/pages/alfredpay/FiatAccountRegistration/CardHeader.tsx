  ...
  return (
    <div className="flex w-full select-none items-center justify-between gap-1.5">
      <div className="flex min-w-0 items-center gap-1">
        ...
        {compact ? (
          <span className="truncate font-medium text-gray-900 text-sm">{methodKey ? METHOD_LABELS[methodKey] : null}</span>
        ) : (
          <p className="truncate font-medium text-gray-900">{methodKey ? METHOD_LABELS[methodKey] : null}</p>
        )}
      </div>
      {methodKey && (
        <span
