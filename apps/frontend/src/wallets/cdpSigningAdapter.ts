...
import { estimateFeesPerGas, estimateGas, getGasPrice, getPublicClient, getTransactionCount } from "@wagmi/core";
import type { Hex } from "viem";
import { waitForTransactionConfirmation } from "../helpers/safe-wallet/waitForTransactionConfirmation";
import { wagmiConfig } from "../wagmiConfig";
import type { EvmWalletSigningAdapter, WalletTransactionRequest } from "./signingAdapter";
...
export function createCdpSigningAdapter(
  ...
  return {
    ...
    waitForTransaction: dependencies.waitForTransaction
  };
}
