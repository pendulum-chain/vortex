    ...
    <section className="bg-gray-50 px-4 py-16 md:px-10 lg:py-32">
      <div className="container mx-auto max-w-5xl">
        <div className="mb-12 text-center">
          <h1 className="mx-auto max-w-3xl text-blue-950 text-h2">
            One small snippet of code to help you <strong>scale your business quickly</strong>
          </h1>
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex items-center gap-2 rounded-lg bg-[#0f172a] px-4 py-2 font-mono text-gray-300 text-sm">
