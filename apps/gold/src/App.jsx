...
function Logo({ compact = false }) {
  return <span className={`wordmark ${compact ? "wordmark--compact" : ""}`}><img src="/brand/ouro-wordmark.png" alt="ouro." />{!compact && <small>uma experiência SatoshiPay</small>}</span>;
}
