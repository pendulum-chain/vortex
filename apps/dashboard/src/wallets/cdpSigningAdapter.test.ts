...
import type { CdpSigningAdapterDependencies } from "./cdpSigningAdapter";
import type { WalletTransactionRequest } from "./signingAdapter";

mock.module("@/lib/wagmi", () => ({ wagmiConfig: {} }));

const { createCdpSigningAdapter } = await import("./cdpSigningAdapter");
...
describe("dashboard CDP signing adapter", () => {
