...
import { Endpoint, type EndpointMapping, type Endpoints, type Methods } from "./mappings";
import {
  DepositLog,
...
const {
  ...
  brlaLoginUsername: BRLA_LOGIN_USERNAME,
  brlaLoginPassword: BRLA_LOGIN_PASSWORD
} = getConfig();
...
export class BrlaApiService {
  ...
  public async sendRequest<M extends Methods, E extends Endpoints>(
    ...
    console.log(`BRLA API Request: ${method} ${fullUrl}`, payload);
