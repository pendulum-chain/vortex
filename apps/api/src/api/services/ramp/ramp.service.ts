...
import { getEphemeralNetworksForQuote, validateEphemeralAccountsFresh } from "./ephemeral-freshness";
...
export class RampService extends BaseRampService {
  ...
  public async registerRamp(request: RegisterRampRequest, _route = "/v1/ramp/register"): Promise<RampProcess> {
    return this.withTransaction(async transaction => {
      ...
      await validateEphemeralAccountsFresh(ephemerals, getEphemeralNetworksForQuote(quote, additionalData));
