...
import { createDestinationApprovalTransaction, encodeEvmTransactionData } from "../../core/evm-transactions";
...
export async function prepareSquidRouterSwapTxs(
  ...
  const backupApproveTransaction = await createDestinationApprovalTransaction({
