...
const EUR_ONRAMP_BASE_CROSS_CHAIN: RampPhase[] = [
  "initial",
  "mykoboOnrampDeposit",
  "fundEphemeral",
  "subsidizePreSwap",
...
describe("EUR cross-chain onramp flow", () => {
  it("defines the phase flow for every non-Base EVM destination", () => {
  ...
  it("simulates to the requested destination with provider fees", async () => {
