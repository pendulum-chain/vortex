...
import * as feeDistributionNamespace from "../core/fee-distribution";
...
mock.module("../core/fee-distribution", () => ({
  ...feeDistributionReal,
...
afterAll(() => {
  ...
  mock.module("../core/fee-distribution", () => ({ ...feeDistributionReal }));
...
describe("BRL Avenia to AssetHub USDC transactions", () => {
