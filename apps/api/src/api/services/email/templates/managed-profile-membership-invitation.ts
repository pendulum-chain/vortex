...
export function renderManagedProfileInvitation(invitationUrl: string): RenderedEmail {
  const body: EmailBody = {
    ...
    heading: "You have been invited to a Vortex organization",
    intro:
      "Sign in to Vortex with the email address that received this invitation to review it. Access is granted only after you explicitly accept and applies to all current and future managed profiles in the organization.",
  ...
  return {
    ...
    subject: "Your Vortex organization invitation",
