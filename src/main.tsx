...
Sentry.init({
  ...
  // Session Replay
  replaysSessionSampleRate: 0.9, // This sets the sample rate at 10%. You may want to change it to 100% while in development and then sample at a lower rate in production.
