export const TOML_FILE_URL = 'https://mykobo.co/.well-known/stellar.toml';
...
export const FUNDING_PUBLIC_KEY = 'GAENCD6BPYV46VEXWI7KH6D6DW342DB3HIVDM4ES2EDJGLX5MPFB74TG';

export const TRANSACTION_CREATOR_URL = 'http://localhost:3002/v1/stellar';
