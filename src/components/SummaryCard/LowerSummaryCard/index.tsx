...
export const LowerSummaryCard = ({ label, amount, icon, symbol, colSpan }: LowerSummaryCardProps) => (
    <div className={`col-span-${colSpan} p-1 h-auto flex flex-col justify-between space-y-0 rounded ${colSpan === 3 ? 'bg-blue-100 bg-opacity-50' : ''}`}>
