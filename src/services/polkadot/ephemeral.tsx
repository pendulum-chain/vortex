...
export function useGetEphemeralAddress() {
  ...
  return useMemo(
    () =>
      async ({ pendulumEphemeralSeed }: OfframpingState) => {
        if (!pendulumNode) {
...
export function useGetEphemeralNonce() {
  ...
  return useMemo(
    () =>
      async ({ pendulumEphemeralSeed }: OfframpingState): Promise<number | undefined> => {
        if (!pendulumNode) {
          throw new Error('Pendulum node not available');
        }
...
export function usePendulumFundEphemeral() {
  ...
  return useCallback(
    async (state: OfframpingState, { wagmiConfig }: ExecutionContext): Promise<OfframpingState> => {
    ...
    [isEphemeralFundedHook, getEphemeralAddressHook],
  );
}
...
export function useGetRawInputBalance() {
  ...
  return useMemo(
    () =>
      async (state: OfframpingState): Promise<Big> => {
        if (!pendulumNode) {
          throw new Error('Pendulum node not available');
        }
    ...
    [pendulumNode, getEphemeralAddressHook],
  );
}
...
export function useSubsidizePreSwap() {
  ...
  return useMemo(
    ...
    [getRawInputBalanceHook, getEphemeralAddressHook],
  );
}
...
export function useSubsidizePostSwap() {
  ...
  return useMemo(
    ...
    [getRawOutputBalanceHook, getEphemeralAddressHook],
  );
}
