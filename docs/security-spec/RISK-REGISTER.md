...
| RISK-013 | Deferred | Medium | Bridge Operations | Deprecated Spacewalk/Stellar paths do not have a complete claimable-balance recovery runbook/mechanism. | Corridors are deprecated; remaining flows retain phase retry and cleanup paths. | Do not re-enable or expand Stellar corridors without an explicit recovery design and runbook. |
