...
- [x] AlfredPay offramp order is created by the block phase registration hook; `processAlfredpayOfframpStart` remains a defensive validation-only no-op. **PASS** — verified.
