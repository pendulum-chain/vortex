...
| **Unauthorized quote consumption** | Attacker binds someone else's quote to their own ramp | Quotes are bound to the authenticated user/partner who created them; ownership is verified at registration |
