...
| Rebalancer | `07-operations/rebalancer.md` | Automated liquidity management — BRLA↔axlUSDC (legacy, Pendulum), cost-aware USDC→BRLA→USDC (Base high-coverage), and cost-aware BRLA→USDC correction (Base low-coverage) |
