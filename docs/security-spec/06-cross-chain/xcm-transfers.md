...
- [ ] Pendulum→AssetHub does not prove AssetHub arrival on re-entry. **ACCEPTED ONLY FOR QUOTE-DISABLED RECOVERY** — tracked in `RISK-REGISTER.md`; this is a release blocker before re-enabling the corridor.
