...
| [`operations-cdp-embedded-wallet-rollout.md`](operations-cdp-embedded-wallet-rollout.md) | CDP production assumptions, enablement gates, smoke tests, and rollback |
