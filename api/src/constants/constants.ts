...
const MOONBEAM_EPHEMERAL_STARTING_BALANCE_UNITS_ETHEREUM = '100'; // Amount to send to the new moonbeam ephemeral account created when onramping to Ethereum
const BRLA_BASE_URL = 'https://api.brla.digital:4567/v1/business'; // TODO - put back production env after testing.
